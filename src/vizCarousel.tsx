    ...
    return (
      ...
      >
        {slides.map((d, i) => (
          <div
            key={i}
            className={`flex box-border flex-wrap w-full shrink-0 snap-start ${vizWidth === 'full' ? 'flex-col' : 'flex-row items-stretch'}`}
          >
            <div
              style={contentStyle}
            ...
            >
              ...
              <div
                className={`flex ${slideNo ? 'gap-2' : 'gap-3'} items-center shrink-0`}
              >
                <div
                  ...
                  onClick={() => {
                    if (WrapperRef.current && slide !== 1) {
                      ...
                      const scrollBy =
                        parentWithDir?.getAttribute('dir') === 'rtl'
                          ? 280
                          : -280;
                      setSlide(slide - 1);
